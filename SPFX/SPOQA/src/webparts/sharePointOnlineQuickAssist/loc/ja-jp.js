define([], function() {
    return {
      ...
      SS_NoCrawlEnabled:"The nocrawl has been enabled for site",
      SS_SiteSearchable1:"Site",
      SS_SiteSearchable2:"is searchable",
      SS_HaveAccess:"You have access to the site",
      SS_NoAccess:"You don't have access to the site",
      SS_InMembers:"You are in the members of the site",
      SS_NotInMembers:"You are not in the members of the site",
      ...
      SS_Message_SiteSearchable:"The site is enabled for search index.",
