...
const INITIAL_OPTIONS: IComboBoxOption[] = [
  { key: 'Admin', text: strings.Admin, itemType: SelectableOptionMenuItemType.Header },
  { key: 'Test', text: strings.Test}]
  ...
  public render(): React.ReactElement<ITeamsQuickAssistProps> {
    ...
    const teamsQADetail = () => {
      switch(this.state.selectedKey) {
        case "Test":   return <TestTeamsQA msGraphClient={this.props.msGraphClient} currentUser={this.props.currentUser} ctx={this.props.ctx}/>;        
